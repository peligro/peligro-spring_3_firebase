package cl.tamila.firebase2.services;

import cl.tamila.firebase2.configuracion.FirebaseInitializer;
import cl.tamila.firebase2.dto.CotizacionesDto;
    ...
    public Map<String, Object> listarPorId(String id){
        ...
        try {
            ApiFuture<DocumentSnapshot> doc =
                    this.firebase.getFirestore().collection("cotizaciones").document(id).get();
